...
class RemoveStepDependencyTool implements ToolContract, ToolMetadataContract
{
    use ResolvesFokusplanTeam;

    public function getName(): string
    {
        return 'fokusplan.steps.dependencies.DELETE';
    }

    public function getDescription(): string
    {
        return 'DELETE /fokusplan/steps/{id}/dependencies - Entfernt eine "Wartet auf"-Abhängigkeit zwischen zwei Maßnahmen. ERFORDERLICH: step_id, depends_on_step_id.';
    }
    ...
    public function getSchema(): array
    {
        return [
            ...
            'properties' => [
                ...
                'depends_on_step_id' => ['type' => 'integer', 'description' => 'ID der vorgelagerten Maßnahme (ERFORDERLICH).'],
            ],
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        try {
            ...
            return ToolResult::success([
                'deleted' => true,
                'message' => "Abhängigkeit zwischen '{$step->title}' und '{$dependsOn->title}' entfernt.",
            ]);
        } catch (\Throwable $e) {
            return ToolResult::error('EXECUTION_ERROR', 'Fehler beim Entfernen der Abhängigkeit: ' . $e->getMessage());
        }
    }
